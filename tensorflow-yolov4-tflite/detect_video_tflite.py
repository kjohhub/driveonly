...
flags.DEFINE_string('output', './detections/test1_tflite.avi', 'path to output video')
...
def main(_argv):
    ...
    while True:
        ...
        record = save_records(classes.numpy()[0], scores.numpy()[0], valid_detections.numpy()[0])
